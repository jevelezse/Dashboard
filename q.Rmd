...
=====================================
```{r echo=FALSE}
conteos <- read.csv('/home/jennifer/Escritorio/conteos1.csv')
...
p <- plot_ly(x = conteos$Caracteristica, y=conteos$No..de.Observaciones,type = "bar")
p
```
...
genes <- read.csv('/home/jennifer/Escritorio/cluster2.csv') 
#genes$edad1 <- gsub(",","-",genes$edad1)#Cambio de coma
...
genes <- read.csv('/home/jennifer/Escritorio/cluster3.csv') 
#genes$edad1 <- gsub(",","-",genes$edad1)#Cambio de coma
#genes %<>% filter(cluster %in% c('c1','c5','c3','c4','c2'))
#genes %<>% filter(cluster %in% c('c1','c3','c5'))
#genes %<>% filter(gen %in% c("BARD1"))#,"BRCA1","ATM","MLH2", "PMS1", "MSH2", "MSH6,
...
genes <- read.csv('/home/jennifer/Escritorio/cluster4.csv') 
#genes$edad1 <- gsub(",","-",genes$edad1)#Cambio de coma
#genes %<>% filter(cluster %in% c('c1','c5','c3','c4','c2'))
#genes %<>% filter(cluster %in% c('c1','c3','c5'))
#genes %<>% filter(gen %in% c("BARD1"))#,"BRCA1","ATM","MLH2", "PMS1", "MSH2", "MSH6,
...
```{r echo=FALSE}
knitr::include_graphics("/home/jennifer/Documentos/clusters/cluster4.png")
```
...
genes <- read.csv('/home/jennifer/Escritorio/cluster5.csv') 
#genes$edad1 <- gsub(",","-",genes$edad1)#Cambio de coma
#genes %<>% filter(cluster %in% c('c1','c5','c3','c4','c2'))
#genes %<>% filter(cluster %in% c('c1','c3','c5'))
#genes %<>% filter(gen %in% c("BARD1"))#,"BRCA1","ATM","MLH2", "PMS1", "MSH2", "MSH6,
